...
plt6 = Plots.plot([0-δ, 0-δ], [0, -L-δ], lw=2, lc=:black, label="")
Plots.plot!(plt6, [0-δ, L+δ], [0, 0], lw=2, lc=:black, label="")
Plots.plot!(plt6, [L, L], [0, -L-δ], lw=1, lc=:black, label="PML", ls=:dash)
Plots.plot!(plt6, [-δ, L+δ], [-L, -L], lw=1, lc=:black, label="", ls=:dash)
Plots.plot!(plt6, [L+δ, L+δ], [0, -L-δ], lw=2, lc=:black, label="")
Plots.plot!(plt6, [0, 0], [0, -L-δ], lw=1, lc=:black, ls=:dash, label="")
Plots.plot!(plt6, [0-δ, L+δ], [-L-δ, -L-δ], lw=2, lc=:black, label="")
Plots.plot!(plt6, getX.(interface₁.(LinRange(0,1,100))), getY.(interface₁.(LinRange(0,1,100))), lc=:red, ls=:dash, lw=1, label="Material Interface")
Plots.plot!(plt6, getX.(interface₂.(LinRange(0,1,100))), getY.(interface₂.(LinRange(0,1,100))), lc=:red, ls=:dash, lw=1, label="")
Plots.plot!(plt6, getX.(interface₃.(LinRange(0,1,100))), getY.(interface₃.(LinRange(0,1,100))), lc=:red, ls=:dash, lw=1, label="", size=(400,500))
xlims!(plt6, (-8, 48))
ylims!(plt6, (-48, 16))
Plots.annotate!(plt6, 20, -5, ("\$ \\Omega_1 \$", 15, :black))
Plots.annotate!(plt6, 20, -15, ("\$ \\Omega_2 \$", 15, :black))
Plots.annotate!(plt6, 20, -25, ("\$ \\Omega_3 \$", 15, :black))
Plots.annotate!(plt6, 20, -35, ("\$ \\Omega_4 \$", 15, :black))
xlabel!(plt6, "\$ x \$")
ylabel!(plt6, "\$ y \$")

plt7 = Plots.contourf(getX.(xy₁), getY.(xy₁), σ.(xy₁) .+ 1e-16, colormap=:jet)
Plots.contourf!(plt7, getX.(xy₂), getY.(xy₂), σ.(xy₂) .+ 1e-16, colormap=:jet)
Plots.contourf!(plt7, getX.(xy₃), getY.(xy₃), σ.(xy₃) .+ 1e-16, colormap=:jet)
Plots.contourf!(plt7, getX.(xy₄), getY.(xy₄), σ.(xy₄) .+ 1e-16, colormap=:jet)
Plots.plot!(plt7, getX.(interface₁.(LinRange(0,1,100))), getY.(interface₁.(LinRange(0,1,100))), lc=:red, ls=:dash, lw=1, label="Material Interface")
Plots.plot!(plt7, getX.(interface₂.(LinRange(0,1,100))), getY.(interface₂.(LinRange(0,1,100))), lc=:red, ls=:dash, lw=1, label="")
Plots.plot!(plt7, getX.(interface₃.(LinRange(0,1,100))), getY.(interface₃.(LinRange(0,1,100))), lc=:red, ls=:dash, lw=1, label="", size=(400,500))
xlims!(plt7, (-8, 48))
ylims!(plt7, (-48, 16))
Plots.annotate!(plt7, 20, -5, ("\$ \\Omega_1 \$", 15, :white))
Plots.annotate!(plt7, 20, -15, ("\$ \\Omega_2 \$", 15, :white))
Plots.annotate!(plt7, 20, -25, ("\$ \\Omega_3 \$", 15, :white))
Plots.annotate!(plt7, 20, -35, ("\$ \\Omega_4 \$", 15, :white))
xlabel!(plt7, "\$ x \$")
ylabel!(plt7, "\$ y \$")
Plots.plot!(plt7, [L, L], [0, -L-δ], lw=1, lc=:black, label="PML", ls=:dash)
Plots.plot!(plt7, [-δ, L+δ], [-L, -L], lw=1, lc=:black, label="", ls=:dash)
Plots.plot!(plt7, [0, 0], [0, -L-δ], lw=1, lc=:black, ls=:dash, label="")

plt8 = Plots.plot()
Plots.contourf!(plt8, getX.(xy₄), getY.(xy₄), τ.(xy₄) .+ 1e-16, colormap=:jet)
Plots.contourf!(plt8, getX.(xy₁), getY.(xy₁), τ.(xy₁) .+ 1e-16, colormap=:jet)
Plots.contourf!(plt8, getX.(xy₂), getY.(xy₂), τ.(xy₂) .+ 1e-16, colormap=:jet)
Plots.contourf!(plt8, getX.(xy₃), getY.(xy₃), τ.(xy₃) .+ 1e-16, colormap=:jet)
Plots.plot!(plt8, getX.(interface₁.(LinRange(0,1,100))), getY.(interface₁.(LinRange(0,1,100))), lc=:red, ls=:dash, lw=1, label="Material Interface")
Plots.plot!(plt8, getX.(interface₂.(LinRange(0,1,100))), getY.(interface₂.(LinRange(0,1,100))), lc=:red, ls=:dash, lw=1, label="")
Plots.plot!(plt8, getX.(interface₃.(LinRange(0,1,100))), getY.(interface₃.(LinRange(0,1,100))), lc=:red, ls=:dash, lw=1, label="", size=(400,500))
xlims!(plt8, (-8, 48))
ylims!(plt8, (-48, 16))
Plots.annotate!(plt8, 20, -5, ("\$ \\Omega_1 \$", 15, :white))
Plots.annotate!(plt8, 20, -15, ("\$ \\Omega_2 \$", 15, :white))
Plots.annotate!(plt8, 20, -25, ("\$ \\Omega_3 \$", 15, :white))
Plots.annotate!(plt8, 20, -35, ("\$ \\Omega_4 \$", 15, :white))
xlabel!(plt8, "\$ x \$")
ylabel!(plt8, "\$ y \$")
Plots.plot!(plt8, [L, L], [0, -L-δ], lw=1, lc=:black, label="PML", ls=:dash)
Plots.plot!(plt8, [-δ, L+δ], [-L, -L], lw=1, lc=:black, label="", ls=:dash)
Plots.plot!(plt8, [0, 0], [0, -L-δ], lw=1, lc=:black, ls=:dash, label="")